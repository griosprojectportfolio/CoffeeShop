...
-(void)showRouteFrom: (CLLocationCoordinate2D)source to:(CLLocationCoordinate2D)destination {
    ...
    MKPointAnnotation *annotationSource = [[MKPointAnnotation alloc]init];
    annotationSource.coordinate = source;

    MKPointAnnotation *annotationDest = [[MKPointAnnotation alloc]init];
    annotationDest.coordinate = destination;

	[mapView addAnnotation:annotationSource];
	[mapView addAnnotation:annotationDest];
	
	routes = [self calculateRoutesFrom:source to:destination];
